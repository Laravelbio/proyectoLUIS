...
<div class="card" style="background:#ffffffee;">
   ...
   <div class="card-body">
                        ...
                        <legend><h6 style="font-weight: 700">INFORMACIÓN INSTALACIÓN</h6></legend><br>
    <form>
                                        ...
                                        <div class="row form-group"> 
                                            ...
                                            <div class="col-md-4">
                                              ...
                                              <div id="sel_referencia">
                                                    ...
                                                    <div  id="nuevo_curso_c" style="padding-left: 80px;padding-top: 2px;"></div><br><br>
                                                    <div class="col-sm-10" id="result_cursonuevo" style="padding-left: 80px;padding-top: 2px;"></div><br>
 ...
 <br>
                                          <legend><h6 style="font-weight: 700">INFORMACIÓN CLIENTE</h6></legend><br>
