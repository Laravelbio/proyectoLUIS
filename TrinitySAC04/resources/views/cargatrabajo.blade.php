                                ...
                                <div class="col-md-6">   
                                      ...
                                      <div class="col-md-9">                                      
                                        <div class="form-check">
                                          <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="Radios" id="Radios1" value="option1" checked>Formato 1 : Otros Trabajos
                                          </label>
                                        </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="row form-group">    
                                      ...
                                      <div class="col-md-9">
                                        <div class="form-check">
                                          <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="Radios" id="Radios2" value="option2">Formato 2 : Instalacion
                                          </label>
                                        </div>
                                      </div>
                                    </div>
